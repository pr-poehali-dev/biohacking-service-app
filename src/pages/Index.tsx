          ...
          >
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="text-white/60 leading-relaxed mb-7 text-sm">Здесь нет чужих рецептов. Только ваш путь. Ваш Ритм. Каждая программа выстраивается под вас. 
Касания веником — едва уловимые, убаюкивающие или глубокие, с пробивками, пробуждающими силу. 
Нанесение соли — нежное, словно шёпот волн, или скрабирующее, очищающее тело и дух. 
Мёд — тёплый, обволакивающий, или с ледяными припарками, дарующими свежесть. 
      ...
      <footer id="contact" className="py-16 px-5 border-t border-white/5">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <p className="text-white/35 text-sm leading-relaxed">Уникальные авторские и традиционные программы парения, по запросу.</p>
          </div>
